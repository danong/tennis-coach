...
def build_parser() -> argparse.ArgumentParser:
    ...
    review_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "skeleton overlay on a clean source-frame JPEG, and write a "
            "deterministic review index (review.json, index.html, "
            "MANIFEST.txt) containing the labels and metadata. Unavailable or "
